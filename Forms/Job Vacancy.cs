...
namespace HR_Applicant_Process_Windows_System_MAIN
{
    public partial class JobVacancies : Form
    {
        ...
        {
            InitializeComponent();
            this.Resize += JobVacancies_Resize;
        ...
        private void JobVacancies_Resize(object sender, EventArgs e)
        {
            int centerX = (this.ClientSize.Width - 900) / 2;

            searchPanel.Left = centerX;
            groupBox2.Left = centerX;
            grpDetails.Left = centerX;
            label9.Left = centerX;

            btnApply.Left = centerX;
            btnRefresh.Left = centerX + 120;
            btnExit.Left = centerX + 240;
