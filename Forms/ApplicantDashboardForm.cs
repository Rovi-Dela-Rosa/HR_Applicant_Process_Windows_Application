...
namespace HR_Applicant_Process_Windows_System_MAIN
{
    public partial class ApplicantDashboardForm : Form
    {
        ...
        {
            int margin = 34;
            int availableWidth = panel2.Width - (margin * 2);

            lblWelcome.Location = new Point(margin, 21);
            lblSubtitle.Location = new Point(margin, 65);

            int cardWidth = (availableWidth / 2) - 6;
            pnlStatusCard.Location = new Point(margin, 105);
            pnlStatusCard.Size = new Size(cardWidth, 139);

            pnlDocsCard.Location = new Point(margin + cardWidth + 12, 105);
            pnlDocsCard.Size = new Size(cardWidth, 139);

            pnlInterview.Location = new Point(margin, 269);
            pnlInterview.Size = new Size(availableWidth, 118);

            pnlUpdates.Location = new Point(margin, 405);
            pnlUpdates.Size = new Size(availableWidth, panel2.Height - 405 - margin);

            lstRecentUpdates.Size = new Size(pnlUpdates.Width - 36, pnlUpdates.Height - 60);
        ...
        private void InitializeComponent()
        {
            ...
            // pnlUpdates
            // 
            pnlUpdates.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            ...
            // pnlInterview
            // 
            pnlInterview.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            ...
            // pnlDocsCard
            // 
            pnlDocsCard.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            ...
            // pnlStatusCard
            // 
            pnlStatusCard.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
