...
namespace HR_Applicant_Process_Windows_System_MAIN
{
    public partial class ApplicantDocuments : Form
    {
        ...
        public ApplicantDocuments(int dynamicID)
        {
            ...
            this.Resize += ApplicantDocuments_Resize;
        }

        private void ApplicantDocuments_Resize(object sender, EventArgs e)
        {
            int margin = 28;
            ...
            btnBack.Location = new Point(this.ClientSize.Width - margin - btnBack.Width, 136);
            btnRefresh.Location = new Point(btnBack.Left - 16 - btnRefresh.Width, 136);
            btnDelete.Location = new Point(btnRefresh.Left - 16 - btnDelete.Width, 136);
            btnUpload.Location = new Point(btnDelete.Left - 16 - btnUpload.Width, 136);

            dgvDocuments.Location = new Point(margin, 339);
            dgvDocuments.Size = new Size(availableWidth, dgvDocuments.Height);

            txtRemarks.Location = new Point(125, txtRemarks.Top);
            txtRemarks.Width = this.ClientSize.Width - 125 - margin;
        }
