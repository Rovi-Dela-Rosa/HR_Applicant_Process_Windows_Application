...
namespace HR_Applicant_Process_Windows_System_MAIN
{
    public partial class Screening2 : Form
    {
        private string connectionString =
            "server=localhost;port=3306;database=hr_recruitment_db;uid=root;pwd=MysqlEnzo;";
        ...
        public Screening2()
        {
            ...
            this.Resize += Screening2_Resize;
        }

        private void Screening2_Resize(object sender, EventArgs e)
        {
            ...
            groupBoxScreening.Left = offsetX - 3;
            groupBoxScreening.Top = offsetY + 3;

            label1.Left = offsetX + 29;
            label1.Top = offsetY + 104;

            cmbApplicant2.Left = offsetX + 208;
            cmbApplicant2.Top = offsetY + 103;

            label2.Left = offsetX + 29;
            label2.Top = offsetY + 163;

            cboStatus.Left = offsetX + 208;
            cboStatus.Top = offsetY + 163;

            label3.Left = offsetX + 29;
            label3.Top = offsetY + 228;

            txtRemarks.Left = offsetX + 208;
            txtRemarks.Top = offsetY + 217;

            btnSave.Left = offsetX + 446;
            btnSave.Top = offsetY + 302;

            dgvScreening.Left = offsetX - 3;
            dgvScreening.Top = offsetY + 427;
            dgvScreening.Width = uiWidth;
        }
